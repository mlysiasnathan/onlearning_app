jQuery(document).ready(function()
{
	...
	var typed = new Typed(".text", {
	  strings:["hello world ","<strong class='primary'>welcome to,</strong> OnLearnig","<strong class='primary'>the best way to </strong>increase your skill","Let start <strong class='primary'>learning</strong>"],
